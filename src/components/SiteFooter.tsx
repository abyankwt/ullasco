      ...
      <div className="container-x py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="bg-white inline-flex rounded-md p-2 mb-4">
            <img src={logo.url} alt="Ullasco" className="h-10 w-auto" width={180} height={80} />
          </div>
          <p className="text-sm text-white/75 leading-relaxed max-w-xs">
            Ullasco Equipments & Machinery provides reliable equipment rental, fleet, transport, and maintenance solutions in Kuwait.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/85">
            <li className="flex gap-3"><MapPin className="size-4 text-primary mt-0.5 shrink-0" /> Kuwait</li>
            <li className="flex gap-3"><Phone className="size-4 text-primary mt-0.5 shrink-0" /> <a href="tel:+96500000000" className="hover:text-primary">+965 0000 0000</a></li>
            <li className="flex gap-3"><Mail className="size-4 text-primary mt-0.5 shrink-0" /> <a href="mailto:info@ullasco.com" className="hover:text-primary">info@ullasco.com</a></li>
            <li className="flex gap-3"><Globe className="size-4 text-primary mt-0.5 shrink-0" /> www.ullasco.com</li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10">
        <div className="container-x py-5 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-white/60">
          <p>© {new Date().getFullYear()} Ullasco for Light & Heavy Equipment & Machinery Co. W.L.L.</p>
          <p>Kuwait • GCC</p>
        </div>
      </div>
    </footer>
